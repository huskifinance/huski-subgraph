...
export class IPancakePair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class IPancakePair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class IPancakePair extends ethereum.SmartContract {
  static bind(address: Address): IPancakePair {
    return new IPancakePair("IPancakePair", address);
  }
  ...
  burn(to: Address): IPancakePair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new IPancakePair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<IPancakePair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new IPancakePair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): IPancakePair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new IPancakePair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<IPancakePair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IPancakePair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
